...
<footer class="container px-4 pt-12 mx-auto md:mt-12 sm:px-6">
	<nav
		class="flex flex-wrap items-center justify-center pt-12 space-x-4 border-t border-gray-200 xs:space-x-10 dark:border-indigo-900"
	>
	...
	<nav class="flex justify-center my-6 space-x-6">
		<a
			href="/"
			class:active={$page.url.pathname === '/'}
			class="text-base font-medium hover:text-indigo-600 dark:text-indigo-200 dark:hover:text-indigo-300"
			sveltekit:prefetch
		>
			Home
		</a>
	...
	<div class="my-8 text-center text-gray-400 sm:my-10">2022 PokéList</div>
</footer>
